...
<body>
            ...
            <div class="container-fluid">
                ...
                <div id="collapsable-nav" class="collapse navbar-collapse">
                    <ul id="nav-list" class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="http://192.168.68.105:3000/login.html">Login</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <div class="mainsignup">
        <p class="sign2" align="center">Welcome!</p>
        <form class="form1" action="server.php" method="post">
            <input class="email" name="email" type="email" required align="center" placeholder="Email*" autocomplete="off" value="<?php echo $email; ?>">
            <input class="un" name="username" type="text" required align="center" placeholder="Username*" autocomplete="off" value="<?php echo $username; ?>" >
            <input class="pass" name="password" type='password' required align='center' placeholder="Password*" autocomplete="off" value="<?php echo $password; ?>">
            <button type="submit" class="submitbtn" name="user_reg" align="center">Sign Up</button>
            <p class="forgot" align="center"><a href="http://192.168.68.105:3000/login.php">Already have an account?
                    Login.</p>
    </div>
